...
},
{
  ...
  difficultyReasons: [
    "落居海岸まで直接行く公共交通がなく、落居口から徒歩約950m歩く",
    "行きの下賀茂での乗り換え時間が1分しかない",
    "帰りの下賀茂での乗り換え時間も2分しかない",
    "路線バスの本数が少なく、乗り遅れると旅程への影響が大きい",
  ],

  image: "/images/ochiikaigan.jpg",

  feature:
    "南伊豆の山と海に囲まれた場所にある、公共交通では少し行きにくい静かな海岸",
  ...
  modelCourse: [
    ...
    },
    {
      ...
      title: "下賀茂",
      detail:
        "12:21発の東海バス・伊浜行きに乗り換えます。乗り換え時間は1分です。",
    },
    {
      time: "12:49",
      title: "落居口",
      detail:
        "ここから落居海岸まで約950m、約13分歩きます。",
    },
    {
      time: "13:04",
      title: "落居海岸",
  ...
  returnCourse: [
    {
      ...
      title: "落居海岸 → 落居口",
      detail:
        "落居口バス停まで約950m、約13分歩きます。",
    },
    {
      time: "15:53",
      title: "落居口",
      detail:
        "16:00発の東海バス・下賀茂行きに乗車します。",
    },
    {
      time: "16:28",
      title: "下賀茂",
      detail:
        "16:30発の東海バス・下田駅行きに乗り換えます。乗り換え時間は2分です。",
    },
    {
      time: "16:55",
      title: "伊豆急下田駅",
  ...
  route: [
    {
      ...
      place: "伊豆急下田駅",
      detail:
        "11:55発。東海バスの下賀茂行きに乗車します。",
    },
    {
      icon: "🚌",
      place: "下賀茂",
      detail:
        "12:20着。12:21発の東海バス・伊浜行きに乗り換えます。",
    },
    {
      icon: "🚌",
      place: "落居口",
      detail:
        "12:49着。ここから落居海岸まで徒歩で向かいます。",
    },
    {
      icon: "🚶",
      place: "落居口 → 落居海岸",
  ...
  returnRoute: [
    {
      ...
      place: "落居海岸 → 落居口",
      detail:
        "15:40発。落居口バス停まで約950m、約13分歩きます。",
    },
    {
      icon: "🚌",
      place: "落居口",
      detail:
        "15:53着。16:00発の東海バス・下賀茂行きに乗車します。",
    },
    {
      icon: "🚌",
      place: "下賀茂",
      detail:
        "16:28着。16:30発の東海バス・下田駅行きに乗り換えます。",
    },
    {
      icon: "🚉",
      place: "伊豆急下田駅",
      detail:
        "16:55着。車なしでの落居海岸への旅は終了です。",
    },
  ],

  busFrequency: "1日5本",
  convenienceStore: "下田駅周辺のみ",
  toilet: "下田駅周辺のみ",
  signal: "要確認",
  vendingMachine: "下田駅周辺のみ",
  restaurant: "下田駅周辺のみ",
  stayTime: "2時間41分",
  ...
  warnings: [
    "行きの下賀茂での乗り換え時間は1分です。",
    "帰りの下賀茂での乗り換え時間は2分です。",
    "路線バスの本数が少ないため、乗り遅れると旅程が大きく変わる可能性があります。",
    "落居口から落居海岸までは片道約950m歩きます。",
  ],

  pitfalls: [
    "行きは下賀茂12:20着から12:21発の伊浜行きへ、1分で乗り換えます。",
    "落居口から落居海岸までは約950m、約13分歩きます。",
    "帰りは落居口16:00発のバスに間に合うよう、落居海岸を15:40頃に出発します。",
    "帰りの下賀茂では16:28着から16:30発の下田駅行きへ、2分で乗り換えます。",
  ],
  ...
  mapUrl:
    "https://www.google.com/maps?q=落居海岸+静岡県南伊豆町&output=embed",
},
{
  id: 16,
  name: "一色の枕状溶岩",
  ...
  difficultyReasons: [
    "曜日や学校の休校日によって利用できるバスが異なる",
    "平日の休校日と土曜日は帰りに約4.4km歩く必要がある",
    "日曜日は浜橋から一色橋まで往復約8.8km歩く必要がある",
    "一色橋周辺を走る路線バスの本数が非常に少ない",
    "事前に運行日と学校の休校日を確認する必要がある",
  ],

  image: "/images/ishiki-pillow-lava.jpg",

  feature:
    "海底火山の噴火によって形成された枕状溶岩を観察できる、西伊豆町のジオスポット",

  routeEntrance: "一色橋",

  // 通常のモデルコースは平日（登校日）を表示
  modelCourse: [
    {
      time: "9:30",
      title: "修善寺駅",
    ...
    },
    {
      ...
      title: "堂ヶ島",
      detail:
        "到着後、昼食を取ります。11:51発の宮ケ原行きに乗り換えます。",
    },
    {
      time: "11:51",
      title: "堂ヶ島",
  ...
  returnCourse: [
    {
      ...
      title: "一色橋",
      detail:
        "東海バスの神田行きに乗車します。この便は休校日運休です。",
    },
    {
      time: "13:35",
      title: "堂ヶ島",
      detail:
        "14:26発の東海バス・特急三島駅行きに乗り換えます。",
    },
    {
      time: "14:26",
      title: "堂ヶ島",
  ...
  route: [
    ...
    },
    {
      ...
      place: "堂ヶ島",
      detail:
        "11:51発。東海バスの宮ケ原行きに乗車します。",
    },
    {
      icon: "🌋",
      place: "一色橋",
      detail:
        "12:05着。一色の枕状溶岩を見学します。",
    },
  ],
  ...
  returnRoute: [
    {
      ...
      place: "一色橋",
      detail:
        "13:21発。東海バスの神田行きに乗車します。休校日は運休します。",
    },
    {
      icon: "🚌",
      place: "堂ヶ島",
      detail:
        "13:35着。14:26発の特急・三島駅行きに乗り換えます。",
    },
    {
      icon: "🚌",
      place: "堂ヶ島",
      detail:
        "14:26発。東海バスの特急・三島駅行きに乗車します。",
    },
    {
      icon: "🚉",
      place: "三島駅",
      detail:
        "16:14着。車なしでの日帰り旅は終了です。",
    },
  ],
      ...
      outbound: [
        {
          time: "9:30",
          title: "修善寺駅",
          detail: "東海バスの快速・松崎行きに乗車します。",
        },
        {
          time: "10:55",
          title: "堂ヶ島",
          detail: "ここで昼食。11:51発の宮ケ原行きに乗り換えます。",
        },
        {
          time: "12:05",
          title: "一色橋",
          detail: "一色の枕状溶岩を見学します。",
        },
      ],
      inbound: [
        {
          time: "13:21",
          title: "一色橋",
          detail: "東海バスの神田行きに乗車します。休校日運休です。",
        },
        {
          time: "13:35",
          title: "堂ヶ島",
          detail: "14:26発の特急・三島駅行きに乗り換えます。",
        },
        {
          time: "16:14",
          title: "三島駅",
      ...
      inbound: [
        {
          time: "13:00",
          title: "一色橋 → 浜橋",
          detail: "約4.4km、約1時間歩きます。",
        },
        {
          time: "14:00",
          title: "浜橋",
          detail: "14:22発の特急・三島駅行きを待ちます。",
        },
        {
          time: "14:22",
          title: "浜橋",
          detail: "東海バスの特急・三島駅行きに乗車します。",
        },
        {
          time: "16:14",
          title: "三島駅",
  ...
  warnings: [
    "曜日と学校の休校日によって利用できるバスが異なります。",
    "一色橋13:21発の神田行きは休校日運休です。",
    "平日の休校日と土曜日は、一色橋から浜橋まで約4.4km歩きます。",
    "日曜日は浜橋と一色橋の間を往復するため、合計約8.8km歩きます。",
    "利用日の運行条件を必ず事前に確認してください。",
  ],

  pitfalls: [
    "平日の登校日は一色橋13:21発のバスを利用できますが、休校日は運休します。",
    "休校日かどうかによって帰りの徒歩距離が大きく変わります。",
    "土曜日の帰りは一色橋から浜橋まで約4.4km、約1時間歩きます。",
    "日曜日は一色橋方面へのバスを利用できないため、浜橋から往復約8.8km歩きます。",
    "浜橋14:22発の特急・三島駅行きに間に合うよう余裕を持って歩いてください。",
  ],
  ...
  mapUrl:
    "https://www.google.com/maps?q=一色の枕状溶岩+静岡県西伊豆町&output=embed",
},
];